def expected_offspring_with_dominant_phenotype(arrayOfGenotypeCounts):
...
try:
	...
	sys.exit()
print "Expected number of offspring displaying the dominant phenotype (assuming two offspring per couple):"
print expected_offspring_with_dominant_phenotype(f.readline().split(" "))